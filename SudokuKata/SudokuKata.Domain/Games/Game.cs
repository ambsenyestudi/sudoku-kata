...
namespace SudokuKata
{
    public class Game
    {
        ...
        public List<string> Play()
        {
            ...
            board = gameBoard.ConstructFullyPopulatedBoard(command, randomService, stateStack, rowIndexStack, colIndexStack, usedDigitsStack, lastDigitStack);
